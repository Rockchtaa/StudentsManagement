...
{
    /// <inheritdoc />
    public partial class SystemsCodes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemeCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemCodeDetails_SystemeCodes_SystemCodeId",
                        column: x => x.SystemCodeId,
                        principalTable: "SystemeCodes",
                        principalColumn: "Id",
